defmodule Advent.Y2019.Day5 do
  ...
  iex> program = Day5.parse_program("3,9,8,9,10,9,4,9,99,-1,8")
  iex> {Day5.run_program(program, [8]), Day5.run_program(program, [3]) }
  {[1], [0]}
  # iex> program = Day5.parse_program("3,9,7,9,10,9,4,9,99,-1,8")
  # iex> {Day5.run_program(program, [3]), Day5.run_program(program, [10])}
  # {[1], [0]}
  # iex> program = Day5.parse_program("3,3,1108,-1,8,3,4,3,99")
  # iex> {Day5.run_program(program, [8]), Day5.run_program(program, [3])}
  # {[1], [0]}
  # iex> program = Day5.parse_program("3,3,1107,-1,8,3,4,3,99")
  # iex> {Day5.run_program(program, [3]), Day5.run_program(program, [10])}
  # {[1], [0]}
  # iex> program = Day5.parse_program("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9")
